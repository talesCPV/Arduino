   ...
   document.getElementById('btnReset').addEventListener('click',()=>{
    ...
    function getValues(){
      const out =  new Object
        ...
        out.ip1 = parseInt(document.querySelector('#ip_1').value)
        out.ip2 = parseInt(document.querySelector('#ip_2').value)
        out.ip3 = parseInt(document.querySelector('#ip_3').value)
        out.ip4 = parseInt(document.querySelector('#ip_4').value)

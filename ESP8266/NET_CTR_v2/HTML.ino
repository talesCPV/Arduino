   ...
   document.getElementById('btnReset').addEventListener('click',()=>{
    ...
    function getValues(){
      const out =  new Object
        ...
        out.ip = []
        ip.push(parseInt(document.querySelector('#ip_1').value))
        ip.push(parseInt(document.querySelector('#ip_2').value))
        ip.push(parseInt(document.querySelector('#ip_3').value))
        ip.push(parseInt(document.querySelector('#ip_4').value))        
    ...
    function refreshData(){     
      ...
      .then((response)=>{
        response.text().then((dados)=>{
            ...
            document.getElementById('ip_1').value = json.ip1
            document.getElementById('ip_2').value = json.ip2
            document.getElementById('ip_3').value = json.ip3
            document.getElementById('ip_4').value = json.ip4
...
//var request = new Request('http://'+op.ip+'/json');

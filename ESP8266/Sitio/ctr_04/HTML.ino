...
<!-- Form p/ envio de dados -->
  <form id="frmMain">
      <input type="hidden" id="call" name="hdn_call" value="0">
      <input type="hidden" id="save" name="hdn_save" value="0">
...
/*      
        ...
        document.querySelector("#save").value = "1"        
        document.querySelector("#data").value = getCheck("luz0")
        frmMain.submit()       
*/         
    })
